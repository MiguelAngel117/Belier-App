...
import views.panels.JPanelReportSales;
 ...
 * @author edwin
 */
public class JDialogConfirmDeleteSaleS extends javax.swing.JDialog {
    ...
    /**
     * Creates new form JDialogConfirmDeleteSaleS
     */
    public JDialogConfirmDeleteSaleS(JFrameMain jFrameMain, java.awt.Frame parent, boolean modal,
    ...
    public JDialogConfirmDeleteSaleS(Frame owner, boolean modal) {
        super(owner, modal);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("¿Desea eliminar esta venta?");
        ...
        try {
            if ((saleCRUD.isExistSale(cod))) {
                if (saleCRUD.delete(cod)) {
                    ...
                    JPanelReportSales jpra = new JPanelReportSales(jFrameMain, jpanelMain);
            ...
            Logger.getLogger(JDialogConfirmDeleteSaleS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogConfirmDeleteSaleS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogConfirmDeleteSaleS dialog = new JDialogConfirmDeleteSaleS(new javax.swing.JFrame(), true);
