...
import views.panels.JPanelRegisterArticle;

/**
 *
 * @author edwin
 */
public class JConfirmDialogCreateProduct extends javax.swing.JDialog {

    private JFrameMain jFrameMain;
    private Garment garment;
    private JPanelMain jpanelMain;
    private JPanelRegisterArticle jPanelRegisterArticle;

    /**
     * Creates new form JConfirmDialogCreateProduct
     */
    public JConfirmDialogCreateProduct(
            JFrameMain jFrameMain,
            java.awt.Frame parent,
            Garment garment,
            JPanelMain jpanelMain,
            JPanelRegisterArticle jPanelRegisterArticle) {
        super(parent, true);
        ...
        this.jPanelRegisterArticle = jPanelRegisterArticle;
        this.garment = garment;
    }

    public JConfirmDialogCreateProduct(Frame owner) {
        super(owner);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("¿Desea registrar este nuevo producto?");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 680, 50));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 370, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (gcrud.create(garment, new TypeCRUD())) {
            ...
            jPanelRegisterArticle.getjTextField2().setText("");
            jPanelRegisterArticle.getjComboBox1().setSelectedIndex(0);
            jPanelRegisterArticle.getjComboBox2().setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JConfirmDialogCreateProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JConfirmDialogCreateProduct dialog = new JConfirmDialogCreateProduct(new javax.swing.JFrame());
