...
public class JConfirmDialogUpdateProductByCode extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JConfirmDialogUpdateProductByCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JConfirmDialogUpdateProductByCode dialog = new JConfirmDialogUpdateProductByCode(new javax.swing.JFrame(), true);
