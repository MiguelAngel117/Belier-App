...
import views.panels.JPanelRegisterSale;

/**
 *
 * @author edwin
 */
public class JConfirmDialogRegisterSale extends javax.swing.JDialog {
    
    private JFrameMain jFrameMain;
    private Sale sale;
    private JPanelRegisterSale jPanelRegisterSale;
    /**
     * Creates new form JConfirmDialogRegisterSale
     */
    public JConfirmDialogRegisterSale(JFrameMain jFrameMain, java.awt.Frame parent, boolean modal,
            Sale sale, JPanelRegisterSale jPanelRegisterSale) {
        super(parent, modal);
    ...
    public JConfirmDialogRegisterSale(Frame owner, boolean modal) {
        super(owner, modal);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 150, 100, 40));

        jLabel3.setBackground(new java.awt.Color(0, 0, 0));
        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("¿Desea registrar esta nueva venta?");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 690, 50));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 150, 100, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JConfirmDialogRegisterSale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JConfirmDialogRegisterSale dialog = new JConfirmDialogRegisterSale(new javax.swing.JFrame(), true);
