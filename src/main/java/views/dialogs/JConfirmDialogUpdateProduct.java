 ...
 * @author edwin
 */
public class JConfirmDialogUpdateProduct extends javax.swing.JDialog {
    
    private JFrameMain jFrameMain;
    private Garment garment;
    private JPanelMain jpanelMain;
    /**
     * Creates new form JConfirmDialogUpdateProduct
     */
    public JConfirmDialogUpdateProduct(JFrameMain jFrameMain, java.awt.Frame parent, boolean modal, 
            Garment garment, JPanelMain jpanelMain) {
        super(parent, modal);
    ...
    public JConfirmDialogUpdateProduct(Frame owner) {
        super(owner);
    }

    public JConfirmDialogUpdateProduct(Frame owner, boolean modal) {
        super(owner, modal);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 150, 100, 40));

        jLabel3.setBackground(new java.awt.Color(0, 0, 0));
        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("¿Desea actualizar la información de este producto?");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 80, 820, 50));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 100, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JConfirmDialogUpdateProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JConfirmDialogUpdateProduct dialog = new JConfirmDialogUpdateProduct(new javax.swing.JFrame(), true);
