 ...
 * @author USER
 */
public class JPanelReportUpdatePurchase extends javax.swing.JPanel {
     ...
     */
    public JPanelReportUpdatePurchase(JFrameMain jFrameMain, JPanelMain jPanelMain) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DEVOLUCIÓN DE COMPRAS");
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                if(new GarmentCRUD().isExistGarmentUpdate(purchase.getGarment())){
                    if(Long.parseLong(purchase.getQuantity()) > 0){
                        JPanelUpdateBuy jpua = new JPanelUpdateBuy(jFrameMain,jpanelMain);
                        ...
                        for (int i = 1; i <= Integer.parseInt(purchase.getQuantity()); i++) {
