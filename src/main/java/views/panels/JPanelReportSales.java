 ...
 * @author USER
 */
public class JPanelReportSales extends javax.swing.JPanel {
     ...
     */
    public JPanelReportSales(JFrameMain jFrameMain, JPanelMain jPanelMain) {
    ...
    public String getInversion(){
        ...
        for (Sale sale: sales) {
            BigInteger number = new BigInteger(sale.getTotal());
            num = num.add(number);
        }
        return formatPesos(num.toString());
    }
        ...
        jPanelBackgroundLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 906, Short.MAX_VALUE)
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                if(new GarmentCRUD().isExistGarmentUpdate(sale.getGarment())){
                    JPanelViewSale jpua = new JPanelViewSale(jFrameMain,jpanelMain);
                    jpanelMain.initPanel(jpua);
                    
                    jpua.getjTextField6().setText(String.valueOf(sale.getId()));
                    jpua.getjTextField2().setText(sale.getGarment());
                    ...
                    jpua.getjTextField4().setText(sale.getUnitPrice());
                    jpua.getjTextField3().setText(String.valueOf(sale.getQuantity()));
                    jpua.getjTextField1().setText(sale.getTotal());
