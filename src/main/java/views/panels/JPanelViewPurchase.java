...
import views.dialogs.JConfirmDialogDeletePurch;

/**
 *
 * @author USER
 */
public class JPanelViewPurchase extends javax.swing.JPanel {
     ...
     */
    public JPanelViewPurchase(JFrameMain jFrameMain, JPanelMain jPanelMain) {
        ...
        jPanelBackgroundLayout.setVerticalGroup(
            ...
            .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(jPanelBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jToggleButtonBack2, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE))
    ...
    private void jToggleButtonBack2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonBack2ActionPerformed
        JPanelReportPurchases jPanelReportPurchases = new JPanelReportPurchases(jFrameMain, jPanelMain);
        jPanelReportPurchases.setLocation(0, 0);
        jPanelReportPurchases.setSize(this.getSize());
        this.removeAll();
        this.add(jPanelReportPurchases, BorderLayout.CENTER);
        this.revalidate();
        this.repaint();

        jPanelMain.initPanel(jPanelReportPurchases);
        ...
        jPanelReportPurchases.getjTable1().setModel(defaultTableModel);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (new PurchaseCRUD().isExistPurchase(Integer.parseInt(jTextField6.getText()))) {
                JConfirmDialogDeletePurch jcdug = null;
                jcdug = new JConfirmDialogDeletePurch(jFrameMain,jFrameMain,
                        true,
                        (Integer.parseInt(jTextField6.getText())), jPanelMain);
                jcdug.setVisible(true);
            } else {
                new Service().initNotification("Error 404 - Esta compra no se encuentra registrado.");
            }
        } catch (SQLException ex) {
