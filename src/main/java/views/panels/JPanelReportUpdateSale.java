 ...
 * @author USER
 */
public class JPanelReportUpdateSale extends javax.swing.JPanel {
     ...
     */
    public JPanelReportUpdateSale(JFrameMain jFrameMain, JPanelMain jPanelMain) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DEVOLUCIÓN DE VENTAS");
        ...
        jLabel4.setText("Por favor, ingrese un producto, un valor o un código de la venta que desea buscar:");
        ...
        jLabel5.setText("Para acceder a la venta, haga doble clic sobre ella:");
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            if(!jTextField1.getText().isEmpty()){
                sales = new SaleCRUD().searchSales(jTextField1.getText().toUpperCase());
            }
            else{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Sale sale = null;
            try {
                sale = pcrud.getSale(value);
            } catch (SQLException ex) {
                Logger.getLogger(JPanelReportUpdateSale.class.getName()).log(Level.SEVERE, null, ex);
            }
            Garment garment = null;
            try {
                garment = new GarmentCRUD().getGarment(sale.getGarment());
            } catch (SQLException ex) {
                Logger.getLogger(JPanelReportUpdateSale.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            try {
                if(new GarmentCRUD().isExistGarmentUpdate(sale.getGarment())){
                    if(Integer.parseInt(sale.getQuantity()) > 0){
                        JPanelUpdateSale jpua = new JPanelUpdateSale(jFrameMain,jpanelMain);
                        jpanelMain.initPanel(jpua);

                        jpua.getjTextField14().setText(String.valueOf(sale.getId()));
                        jpua.getjTextField10().setText(String.valueOf(garment.getCod()));
                        jpua.getjTextField16().setText(garment.getName());
                        jpua.getjTextField13().setText(garment.getSex());
                        jpua.getjTextField15().setText(garment.getNameType());

                        jpua.getjTextField12().setText(sale.getUnitPrice());
                        jpua.getjTextField11().setText(String.valueOf(sale.getQuantity()));
                        jpua.getjTextField9().setText(sale.getTotal());

                        for (int i = 1; i <= Integer.parseInt(sale.getQuantity()); i++) {
                            jpua.getjComboBox2().addItem(String.valueOf(i));
                        }
                    }
                    else{
                        new Service(jFrameMain).initNotification("Esta venta no tiene unidades disponibles para reembolsar.",2);
                    }
                }
                else{
                    new Service(jFrameMain).initNotification("El producto de la venta ya no se encuentra registrado en el sistema.",2);
                }
            } catch (SQLException ex) {
